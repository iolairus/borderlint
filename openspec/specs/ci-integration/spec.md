...
## Purpose
Ready-made integration surfaces that run borderlint inside a developer or CI workflow (e.g. the
pre-commit hook), wrapping the existing CLI without adding scan behaviour.
